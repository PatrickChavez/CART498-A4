...
One aspect that I wish I could change is the robustness of “gpt-image-1-
mini”. According to Google Gemini, an image model generator is unable to have a “developer role” like a text generator, meaning that depicting a “Jungian dreamscape” must be done via a prompt from the user. This restriction is why I decided to include terms and archetypes in the web app instructions. Ideally, I would like to create a situation where the image model can generate an image with Jungian concepts without the need for the user to type in keywords.

I would have also like to work more on the aesthetics of the web app; maybe I could have made the video background more responsive by changing its color when the image is generated. The instructions could have also been clickable so the viewer could get a pop-up modal with a list of terms; that way, the viewer can simply copy and paste the term they want to use. 
